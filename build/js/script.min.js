...
},e.fn.slick=function(){var e,i,o=this,s=arguments[0],n=Array.prototype.slice.call(arguments,1),r=o.length;for(e=0;e<r;e++)if("object"==typeof s||"undefined"==typeof s?o[e].slick=new t(o[e],s):i=o[e].slick[s].apply(o[e].slick,n),"undefined"!=typeof i)return i;return o}}),jQuery(document).ready(function(e){e('a[href^="#"]').click(function(t){t.preventDefault();var i=e(this).attr("href");return e("body, html").animate({scrollTop:e(i).offset().top},500),!1}),e(".examples__gallery").slick({infinite:!0,dots:!1,arrows:!0,slidesToShow:3,slidesToScroll:1,centerMode:!0,centerPadding:"0",responsive:[{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]}),e(".reviews__gallery").slick({infinite:!0,dots:!1,arrows:!0,slidesToShow:1,slidesToScroll:1,centerMode:!0,centerPadding:"0"});var t=55.88861,i=37.636411;if(e(window).width()<1200&&e(window).width()>=768)var o=new GMaps({el:".map__inner",lat:t,lng:i+.008,scrollwheel:!1});else if(e(window).width()<768)var o=new GMaps({el:".map__inner",lat:t,lng:i,scrollwheel:!1});else var o=new GMaps({el:".map__inner",lat:t,lng:i+.012,scrollwheel:!1});o.drawOverlay({lat:t,lng:i,content:'<div class="pin">Главный офис находится по адресу:<br>г. Москва, Чермянский проезд, 9</div>'});var s=e(".form");s.each(function(){var t=e(this);e.validator.messages.required="",e(t).validate({errorClass:"error",validClass:"valid"}),t.submit(function(i){t.valid()&&e.ajax({type:t.attr("method"),url:t.attr("action"),data:t.serialize()}).done(function(){t.find(".form__inner").css("visibility","hidden"),t.find(".form__thanks").show(),console.log("done")}),i.preventDefault()})})});